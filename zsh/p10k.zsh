# Generated by Powerlevel10k configuration wizard on 2026-01-01 at 12:08 UTC.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#585b70'
  ...
  function my_git_formatter() {
    ...
    local       meta='%F{#cdd6f4}' # white foreground / mocha text
    local      clean='%F{#11111b}' # black foreground / crust
    local   modified='%F{#11111b}' # black foreground / crust
    local  untracked='%F{#11111b}' # black foreground / crust
    local conflicted='%F{#f38ba8}' # red foreground / mocha red
